...
This can be seen in the image below. If a country is filled with white, then that country's GDP data was unavailable for that year.
...
Filters can also be applied based on the GDP ranges, allowing the user to view specific countries in each GDP bracket.
